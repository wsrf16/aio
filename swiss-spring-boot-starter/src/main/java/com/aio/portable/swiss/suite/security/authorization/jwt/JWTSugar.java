...
public abstract class JWTSugar {
     ...
     * @return
     */
    public static String sign(JWTCreator.Builder builder, Algorithm algorithm) {
...
//     * @return
//     */
//    public static DecodedJWT parseByHMAC256(String token, String secret) {
...
//     * @return
//     */
//    public static DecodedJWT parseByHMAC(String token, AlgorithmSugar.HMAC hmac, String secret) {
...
//     * @return
//     */
//    public static DecodedJWT parseByECDSA(AlgorithmSugar.ECDSA ecdsa, String token, ECPublicKey publicKey, ECPrivateKey privateKey) {
...
//     * @return
//     */
//    public static DecodedJWT parseByRSA(String token, AlgorithmSugar.RSA rsa, RSAPublicKey publicKey, RSAPrivateKey privateKey) {
...
//    }
     ...
     * @return
     */
    public static boolean validate(String token, Algorithm algorithm) {
        boolean validate;
        try {
...
//                validate = false;
    ...
    public static Boolean isExpired(String token, Algorithm algorithm) {
        Boolean isExpired;
        try {
    ...
    public static JWTCreator.Builder withClaim(JWTCreator.Builder builder, String name, Object value) {
...
//         * @return
//         */
//        public static String signForTokenByHMAC256(JWTCreator.Builder builder, String secret) {
//            Algorithm algorithm = AlgorithmSugar.newHMAC(AlgorithmSugar.HMAC.HMAC256, secret);
...
//         * @return
//         */
//        public static String signForTokenByRSA256(JWTCreator.Builder builder, RSAPublicKey publicKey, RSAPrivateKey privateKey) {
...
//         * @return
//         */
//        public static DecodedJWT parseTokenByHMAC256(String token, String secret) {
...
//         * @return
//         */
//        public static DecodedJWT parseTokenByRSA256(String token, RSAPublicKey publicKey, RSAPrivateKey privateKey) {
...
//    public static Date getExpiredSeconds(Calendar calendar, int seconds) {
//        return DateTimeSugar.CalendarUtils.add(calendar, Calendar.SECOND, seconds).getTime();
//    }
//
//    public static Date getExpiredMinutes(Calendar calendar, int minutes) {
//        return DateTimeSugar.CalendarUtils.add(calendar, Calendar.MINUTE, minutes).getTime();
//    }
//
//    public static Date getExpiredHours(Calendar calendar, int hours) {
//        return DateTimeSugar.CalendarUtils.add(calendar, Calendar.HOUR_OF_DAY, hours).getTime();
//    }
//
//    public static Date getExpiredDays(Calendar calendar, int days) {
//        return DateTimeSugar.CalendarUtils.add(calendar, Calendar.DAY_OF_YEAR, days).getTime();
//    }
//
//    public static Date getExpired(Calendar calendar, int calendarField, int mount) {
...
//    }
    ...
    public static boolean isExpired(Date expiredDate, Date now) {
        return now.after(expiredDate);
    }

//    public static Date now(Calendar calendar) {
