package com.aio.portable.swiss.suite.storage.rds.freedatasource;
...
public abstract class FreeDataSourceAspect {
    ...
    @Pointcut("@annotation(com.aio.portable.swiss.suite.storage.rds.freedatasource.TargetDataSource)" +
            " || @within(com.aio.portable.swiss.suite.storage.rds.freedatasource.TargetDataSource)")
