...
import com.aio.portable.swiss.suite.security.authentication.jwt.Credentials;
...
//@Configuration
public abstract class HamletJWTAuthenticationInterceptor implements HandlerInterceptor {
    @Autowired
    JWTAction jwtAction;
