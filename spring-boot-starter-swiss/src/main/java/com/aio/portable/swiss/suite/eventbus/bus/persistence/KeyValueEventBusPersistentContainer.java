...
public class KeyValueEventBusPersistentContainer extends PersistentContainer {
    ...
    public KeyValueEventBusPersistentContainer(@NotNull KeyValuePersistence keyValuePersistence) {
