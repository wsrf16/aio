...
public class LogHubUtils {
    ...
    private static void initialSingletonLogFactory(ConfigurableListableBeanFactory beanFactory) {
...
//    private static void initialSingletonLogFactory(BeanDefinitionRegistry registry) {
