...
public class RestTemplateSubscriber extends Subscriber {
...
//        this.restTemplate = restTemplate;
    ...
    private <E extends Event> ResponseEntity<String> proxy(Function<E, ResponseEntity<String>> func, E event) {
    ...
    private ResponseEntity<String> echoError(Exception e) {
        ...
        ResponseEntity<String> errorResponseEntity = RestTemplater.exchange(restTemplate, errorURL, HttpMethod.POST, httpHeaders, LogThrowable.build(e), String.class);
        return errorResponseEntity;
    }

    private ResponseEntity<String> echoBack(ResponseEntity<?> responseEntity) {
        HttpHeaders httpHeaders = RestTemplater.Http.jsonHttpHead();
