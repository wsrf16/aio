package com.aio.portable.swiss.suite.eventbus.group.persistence;
...
public class KeyValueEventGroupPersistentContainer extends PersistentContainer {
    ...
    public KeyValueEventGroupPersistentContainer(@NotNull KeyValuePersistence keyValuePersistence) {
