package com.york.portable.swiss.hamlet.interceptor.log;
...
class AbstractWebLogAspect {
    ...
    protected final static String LOG_MARKER_TYPENAME = "com.york.portable.swiss.assist.log.annotation.LogMarker";
    protected final static String LOG_MARKER_EXCEPT_TYPENAME = "com.york.portable.swiss.assist.log.annotation.LogMarkerExcept";
