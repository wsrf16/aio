...
//    }
    ...
    private static class BlahUnit {
        private static void todo() throws IOException, ClassNotFoundException, IllegalAccessException, InstantiationException {
            ResourceUtils.ByClassLoader.getResources("com/york/portable/swiss/sandbox/a中文/AA.class");
            ResourceUtils.ByClassLoader.getResourcesByClassName("com.york.portable.swiss.sandbox.Wood");
