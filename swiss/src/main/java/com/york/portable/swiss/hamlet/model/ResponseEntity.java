...
public class ResponseEntity<T> {
     ...
     * @return
     */
    public static <T> ResponseEntity<T> build(int statusCode, T data) {
        return new ResponseEntity<>(statusCode, null, data);
    }
     ...
     * @return
     */
    public static <T> ResponseEntity<T> build(int statusCode, String message, T data) {
