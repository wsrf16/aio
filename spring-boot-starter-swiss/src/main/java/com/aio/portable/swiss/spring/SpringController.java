...
public class SpringController {
    ...
    public static final ResponseEntity<Object> forward(RestTemplate restTemplate, HttpServletRequest request, String shimContextPath) {
        ...
        ResponseEntity<Object> responseEntity = RestTemplater.create(restTemplate)
                .forward(request, contextPath, Object.class);
