package com.aio.portable.swiss.structure.database.freedatasource;
...
public abstract class FreeDataSourceAspect {
    ...
    @Pointcut("@annotation(com.aio.portable.swiss.structure.database.freedatasource.TargetDataSource)" +
            " || @within(com.aio.portable.swiss.structure.database.freedatasource.TargetDataSource)")
