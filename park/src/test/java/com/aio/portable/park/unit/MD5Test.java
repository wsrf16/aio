...
public class MD5Test {
    @Test
    public void foobar() {
        String md5AsHex = SpringMD5Convert.md5AsHex("1");
        String md5AsBase64 = SpringMD5Convert.md5AsBase64("1");

        String s1 = SpringMD5Convert.md5FromBase64ToHex(md5AsBase64);
        String s2 = SpringMD5Convert.md5FromHexToBase64(md5AsHex);
