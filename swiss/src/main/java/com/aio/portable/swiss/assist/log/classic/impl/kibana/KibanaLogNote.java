package com.aio.portable.swiss.assist.log.classic.impl.kibana;
...
import com.aio.portable.swiss.sugar.DateTimeWorld;
...
public class KibanaLogNote {
    ...
    public KibanaLogNote(String message, String esIndex, String level, String className, LogException logException, String serverIp, String hostName, long appId, String appEnv) {
        ...
        setEsIndex(esIndex);
        setTimeStamp(DateTimeWorld.Format.convertDate2String("yyyy-MM-dd'T'HH:mm:ss.SSSZ", new Date()));
    ...
    public KibanaLogNote(LogNote logNote, String esIndex, String serverIp) {
        ...
        setEsIndex(esIndex);
        setServerIp(serverIp);
        setTimeStamp(DateTimeWorld.Format.convertDate2String(DateTimeWorld.Format.FORMAT_ISO8601, new Date()));
    }
