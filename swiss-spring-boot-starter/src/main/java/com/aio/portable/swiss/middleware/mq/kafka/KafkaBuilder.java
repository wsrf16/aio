...
public class KafkaBuilder {
    public static <K, V> DefaultKafkaProducerFactory<K, V> buildProducerFactory(KafkaProperties properties) {
        Map<String, Object> producerProperties = properties.buildProducerProperties();
        return new DefaultKafkaProducerFactory<>(producerProperties);
    }

    public static <K, V> DefaultKafkaProducerFactory<K, V> buildProducerFactory(KafkaProperties properties, Map<String, Object> additionalProperties, String transactionIdPrefix) {
        Map<String, Object> producerProperties = properties.buildProducerProperties();
    ...
    public static <K, V> DefaultKafkaConsumerFactory<K, V> buildConsumerFactory(KafkaProperties properties) {
        Map<String, Object> consumerProperties = properties.buildConsumerProperties();
        return new DefaultKafkaConsumerFactory<>(consumerProperties);
    }

    public static <K, V> DefaultKafkaConsumerFactory<K, V> buildConsumerFactory(KafkaProperties properties, Map<String, Object> additionalProperties) {
        Map<String, Object> consumerProperties = properties.buildConsumerProperties();
    ...
    public static <K, V> KafkaTemplate<K, V> buildTemplate(KafkaProperties properties) {
