...
public abstract class AlgorithmSugar {
    ...
    public static Algorithm newHMAC(HMAC hmac, String secret) {
        Algorithm algorithm;
        switch (hmac) {
            case HMAC512:
    ...
    public static Algorithm newRSA(RSA rsa, RSAPublicKey publicKey, RSAPrivateKey privateKey) {
        Algorithm algorithm;
        switch (rsa) {
            case RSA512:
    ...
    public static Algorithm newECDSA(ECDSA ecdsa, ECPublicKey publicKey, ECPrivateKey privateKey) {
        Algorithm algorithm;
        switch (ecdsa) {
            case ECDSA512:
