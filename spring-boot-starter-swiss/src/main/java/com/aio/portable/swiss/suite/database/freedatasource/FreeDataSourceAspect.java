...
public abstract class FreeDataSourceAspect {
    ...
    @Pointcut("@annotation(com.aio.portable.swiss.suite.database.freedatasource.TargetDataSource)" +
            " || @within(com.aio.portable.swiss.suite.database.freedatasource.TargetDataSource)")
