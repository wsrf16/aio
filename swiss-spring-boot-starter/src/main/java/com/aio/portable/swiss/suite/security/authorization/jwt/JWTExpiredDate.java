...
//    public static JWTExpiredDate getExpiredMinutes(int expiredMinutes) {
...
//    }
    ...
    public static JWTExpiredDate getExpiredSeconds(Calendar issuedAt, int expiredSeconds) {
        return new JWTExpiredDate(issuedAt, Calendar.SECOND, expiredSeconds);
    }

    public static JWTExpiredDate getExpiredSeconds(int expiredSeconds) {
        Calendar now = DateTimeSugar.CalendarUtils.now();
        return new JWTExpiredDate(now, Calendar.SECOND, expiredSeconds);
    }

    public static JWTExpiredDate getExpiredMinutes(Calendar issuedAt, int expiredMinutes) {
    ...
    public static JWTExpiredDate getExpiredHours(Calendar issuedAt, int expiredHours) {
        return new JWTExpiredDate(issuedAt, Calendar.HOUR_OF_DAY, expiredHours);
    }

    public static JWTExpiredDate getExpiredHours(int expiredHours) {
        Calendar now = DateTimeSugar.CalendarUtils.now();
        return new JWTExpiredDate(now, Calendar.HOUR_OF_DAY, expiredHours);
    }

    public static JWTExpiredDate getExpiredDays(Calendar issuedAt, int expiredDays) {
        return new JWTExpiredDate(issuedAt, Calendar.DAY_OF_YEAR, expiredDays);
    }

    public static JWTExpiredDate getExpiredDays(int expiredDays) {
        Calendar now = DateTimeSugar.CalendarUtils.now();
