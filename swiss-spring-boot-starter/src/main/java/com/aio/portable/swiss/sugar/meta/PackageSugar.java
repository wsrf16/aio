...
//    }
    ...
    public static List<String> getClassNameList(String packageName) {
        ...
        List<URL> urlList = ResourceSugar.getClassLoaderResourceList(packagePath);
...
//    private static final String EXT_CLASS = "class";
     ...
     * @return List<String>
     */
    public static List<String> getClassNameByPath(String packagePath) {
...
//                String extension = StringUtils.getFilenameExtension(childFilePath);
                if (childFilePath.endsWith(EXT_DOT_CLASS)) {
                    ...
                    List<URL> resourcesInJar = ResourceSugar.getJarResourceList(childFilePath);
                    List<String> classNameList = resourcesInJar.stream()
                            .filter(c -> c.toString().endsWith(EXT_DOT_CLASS))
                            .map(c -> ResourceSugar.convertJarURLToClassName(c.toString()))
                            .collect(Collectors.toList());
     ...
     * @throws IOException
     */
    public static List<String> getClassNameByJar(String packageURLInJar) {
        try {
